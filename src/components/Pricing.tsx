  ...
  return (
    <section className={`bg-background py-8`} id="pricing">
      <div className={`container mx-auto px-2 pt-4 pb-12 text-primary`}>
        ...
        <div
          className={`flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4 sm:pt-0`} 
        >
          {/* add distance between div */}

          <div
            className={`flex flex-col w-full sm:w-1/2 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-background mt-4 `}
          >
            <div
          ...
          <div
            className={`flex flex-col w-full sm:w-1/2 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-primary mt-4 `}
          >
            <div
              className={`flex-1 bg-background text-gray-600 rounded-t rounded-b-none overflow-hidden shadow`}
            >
